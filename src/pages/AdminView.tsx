...
export default function AdminView({
  ...
  const [adminSection, setAdminSection] = useState<'overview' | 'users' | 'categories' | 'vocabulary' | 'blog'>('overview');
  ...
  const SECTION_META = {
    ...
    blog:       { title: 'Quản Lý Blog',         desc: 'Tạo, chỉnh sửa và xuất bản bài viết cộng đồng.' },
  } as const;
